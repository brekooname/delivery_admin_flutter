                                          ...
                                          e.isVerifiedDeliveryMan! == 1
                                              ...
                                              : SizedBox(
                                                  ...
                                                  child: ElevatedButton(
                                                      onPressed: () async {
                                                        appStore.setSelectedMenuIndex(
                                                            DELIVERY_PERSON_DOCUMENT_INDEX);
                                                        await launchScreen(
                                                            context,
                                                            BodyCornerWidget(
                                                              child: DeliveryPersonDocumentWidget(
                                                                  deliveryManId:
                                                                      e.id!),
                                                            ));
                                                      },
