...
Widget paginationWidget(BuildContext context,
    ...
    int perPage = 10,
    required Function(int currentPage, int perPage) onUpdate}) {
                ...
                DropdownButton<int>(
                    ...
                    items: List.generate(perPageList.length, (index) {
                      ...
                      return DropdownMenuItem(
                          child: Text(item == -1 ? language.all : '$item'),
                          value: item);
                    }),
                    onChanged: (value) {
                      currentPage = 1;
        ...
        Container(
          ...
          child: IntrinsicHeight(
            child: Row(
              ...
              children: [
                Text(
                    '${language.page} $currentPage ${language.lbl_of} $totalPage',
                    style: primaryTextStyle()),
                SizedBox(width: 12),
                VerticalDivider(),
                SizedBox(width: 12),
                DropdownButton<int>(
                    ...
                    items: List.generate(totalPage, (index) {
                      return DropdownMenuItem(
                          child: Text('${index + 1}'), value: index + 1);
                    }),
                    onChanged: (value) {
                      currentPage = value!;
                      onUpdate.call(currentPage, perPage);
        ...
        content: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              if (isForceDelete)
                Text(language.you_delete_this_recover_it,
                    style: secondaryTextStyle(), textAlign: TextAlign.center),
            ],
          ),
        ),
