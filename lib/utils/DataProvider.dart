...
import 'package:local_delivery_admin/components/CoorporateWidget.dart';
...
import 'package:local_delivery_admin/screens/UserInvoiceFilter.dart';
...
import '../screens/DriverInvoiceScreen.dart';
...
List<MenuItemModel> getMenuItems() {
  ...
  list.add(MenuItemModel(
      ...
      widget: DeliveryPersonDocumentWidget()));
  list.add(MenuItemModel(
      index: USER_INDEX,
...
List<StaticPaymentModel> getStaticPaymentItems() {
  ...
  list.add(StaticPaymentModel(
      title: language.pay_stack, type: PAYMENT_GATEWAY_PAYSTACK));
  list.add(StaticPaymentModel(
      title: language.flutter_wave, type: PAYMENT_GATEWAY_FLUTTERWAVE));
  list.add(
      StaticPaymentModel(title: language.paypal, type: PAYMENT_GATEWAY_PAYPAL));
  list.add(StaticPaymentModel(
      title: language.paytabs, type: PAYMENT_GATEWAY_PAYTABS));
  list.add(StaticPaymentModel(
      title: language.mercado_pago, type: PAYMENT_GATEWAY_MERCADOPAGO));
  list.add(
      StaticPaymentModel(title: language.paytm, type: PAYMENT_GATEWAY_PAYTM));
  list.add(StaticPaymentModel(
      title: language.my_fatoorah, type: PAYMENT_GATEWAY_MYFATOORAH));
  return list;
}
